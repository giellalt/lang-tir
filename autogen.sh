...
function print_usage() {
    ...
    echo "  -l, --add-langvar   Add env. variable \$GTLANG_tir to login script."
...
# the current dir:
if   test x${GTLANG_tir} = x ; then
	echo "WARNING: The variable \${GTLANG_tir} has not been defined. You"
	...
	echo "$0 -l"
	echo
elif test x${GTLANG_tir} != x${LANGDIR} ; then
	echo "WARNING: The variable \${GTLANG_tir} has the value:"
	echo "  ${GTLANG_tir}"

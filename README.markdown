...
This directory contains source files for the Tigrinya language
...
-   <https://giellalt.uit.no/lang/doc/index.html> (analyser)
...
The Tigrinya language sources can be acquired using [giella SVN
